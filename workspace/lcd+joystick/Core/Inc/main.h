...
#define BlueButton_Pin GPIO_PIN_4
#define BlueButton_GPIO_Port GPIOA
#define GreenButton_Pin GPIO_PIN_5
#define GreenButton_GPIO_Port GPIOA
#define YellowButtonm_Pin GPIO_PIN_6
#define YellowButtonm_GPIO_Port GPIOA
...
#define JoyStick_SW_Pin GPIO_PIN_6
...
#define RedButton_Pin GPIO_PIN_12
#define RedButton_GPIO_Port GPIOC
